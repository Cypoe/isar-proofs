...
\begin{itemize}
    \item \textbf{Paper 2 (Continuous Approximation)}: Extension of the discrete kernel to real-valued physical quantities and continuous address spaces. Unique representation in a completion of \texttt{KernelAddress} is axiomatic (\texttt{ISAR\_UAT} stays named; there is no metric on \texttt{KernelAddress}). Classical citations: Cybenko~\cite{cybenko1989approximation} and Leshno et al.~\cite{leshno1993multilayer}.
