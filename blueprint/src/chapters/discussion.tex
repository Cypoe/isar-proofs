...
\begin{itemize}
    \item \textbf{Paper 2 (Continuous Approximation)}: Extension of the discrete kernel to real-valued physical quantities, continuous address spaces, and metric completions, proving the unique continuous representation limit.
    \item \textbf{Paper 3 (Hardware Compilation)}: Verification of the compilation path from the algebraic matrix representations to optimal virtual machines (HVM2) and relational database schemas.
\end{itemize}
